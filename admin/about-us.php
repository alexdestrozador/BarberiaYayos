...
$pagedes=$_POST['pagedes'];
    ...
    if ($query) {
    $msg="Tu página Quienes somos, ha sido actualizada satisfactoriamente.";
  }
  else
    {
...
<html>
<head>
<title> Yayo's Barber| Quienes somos</title>
	...
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">Actualizar Quienes somos</h3>
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>Actualizar Quienes somos:</h4>
						</div>
						<div class="form-body">
							<form method="post">
