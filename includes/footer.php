      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md">
            ...
            <h3 class="mb-4">Yayo's Barber</h3>
              <?php
...
?>
              <p><?php  echo substr($row['PageDescription'],0,200);?> <a href="#quienessomos">Ver más.......</a></p><?php } ?>
